...
#ifndef TEST_APPIUM_IOS_SWIFT_H
#define TEST_APPIUM_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="test_appium_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15test_appium_ios11AppDelegate")
...
SWIFT_CLASS("_TtC15test_appium_ios13SceneDelegate")
...
SWIFT_CLASS("_TtC15test_appium_ios14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified textField1;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified textField2;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified button;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified textResult;
- (void)viewDidLoad;
- (IBAction)somarValoresWithSender:(UIButton * _Nonnull)sender;
